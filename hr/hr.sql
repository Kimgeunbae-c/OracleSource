...
on e.DEPARTMENT_ID = d.DEPARTMENT_ID
 ...
 FROM EMPLOYEES e ,(SELECT e.DEPARTMENT_ID, round(AVG(e.SALARY)) AS dept_sal_avg
 FROM EMPLOYEES e 
 WHERE e.DEPARTMENT_ID IS NOT null
 GROUP BY e.DEPARTMENT_ID) p
 where e.DEPARTMENT_ID = p.DEPARTMENT_ID and p.dept_sal_avg < e.SALARY ORDER BY e.DEPARTMENT_ID;
